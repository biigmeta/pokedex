...
export default function Search({ setSelectedType }) {
    ...
    return (
        <div className="p-2 bg-[var(--color-bg)]">
            ...
            <ul className="items-center w-full grid grid-cols-7 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white">

...
function PokemonCard({ data }) {
  ...
  return <div className="min-h-[320px] shadow p-2 rounded hover:scale-[1.015] duration-300">
    {pokemonData ? <>
      <Image src={pokemonData.sprites.front_default} width={240} height={240} alt={`${pokemonData.name} image`}
        className="w-full object-contain" />
      <p className="text-center capitalize">{pokemonData.name}</p></> : <AnimatedLoading />}
